...
export function getAudioMapping(bacAudioMapping : string) : AudioMappingType {
  /*
      what is AudioMappingType.AudioAll - where does this come from?
      autorun
        difference between GetAudioMappingValue and GetAudioMappingSpan
            AudioAll is associated with GetAudioMappingSpan
        audioMappingSpan may be missing from bacon
   */
